...
export const TURRET_CONFIGS = [
    { level: 1, name: 'Mk I', unlockCost: 1000, damage: 8, fireRate: 4, range: 204 },
    { level: 2, name: 'Mk II', unlockCost: 2000, damage: 11, fireRate: 5, range: 228 },
    { level: 3, name: 'Mk III', unlockCost: 4000, damage: 15, fireRate: 6, range: 258 },
    { level: 4, name: 'Mk IV', unlockCost: 8000, damage: 20, fireRate: 7, range: 288 },
    { level: 5, name: 'Mk V', unlockCost: 16000, damage: 28, fireRate: 8, range: 324 }
] as const;
